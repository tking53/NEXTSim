...
// Tue Apr  4 15:51:40 2017 by ROOT version 5.34/36
...
#ifdef AnlClass_cxx
AnlClass::AnlClass(TTree *tree) : fChain(0) 
{
...
Int_t AnlClass::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t AnlClass::LoadTree(Long64_t entry)
{
...
void AnlClass::Show(Long64_t entry)
{
...
Int_t AnlClass::Cut(Long64_t entry)
{
