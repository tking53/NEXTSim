...
#ifndef CloverSingleHit_h
#define CloverSingleHit_h 1
...
class CloverSingleHit : public G4VHit
{
  public:

      CloverSingleHit();
     ~CloverSingleHit();
      CloverSingleHit(const CloverSingleHit&);
      const CloverSingleHit& operator=(const CloverSingleHit&);
      G4int operator==(const CloverSingleHit&) const;
...
typedef G4THitsCollection<CloverSingleHit> CloverSingleHitsCollection;

extern G4Allocator<CloverSingleHit> CloverSingleHitAllocator;

inline void* CloverSingleHit::operator new(size_t)
{
  void *aHit;
  aHit = (void *) CloverSingleHitAllocator.MallocSingle();
  return aHit;
}

inline void CloverSingleHit::operator delete(void *aHit)
{
  CloverSingleHitAllocator.FreeSingle((CloverSingleHit*) aHit);
}
