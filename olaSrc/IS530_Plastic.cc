...
G4VPhysicalVolume* IS530_Plastic::Construct()
{
  ...
  // DETECTOR PLACEMENT
    ...
    IS530_Plastic_name.push_back("../STL_export/Bucharest_Plastic/Bucharest_Plastic.stl");
    IS530_Plastic_name.push_back("../STL_export/Bucharest_Plastic/Bucharest_Plastic_back.stl");
    IS530_Plastic_name.push_back("../STL_export/Bucharest_Plastic/Bucharest_Plastic_holders.stl");
    IS530_Plastic_name.push_back("../STL_export/Bucharest_Plastic/Tape.stl");
