...
G4VPhysicalVolume* CloverQuadBuchDetector::Construct()
{
    ...
    //
    // Meshing
    mesh_Capsule	= new CADMesh(const_cast<char*>("../STL_export/Clover_Bucharest_RefFace/Clover_Assembly_Bucharest_RefModif_Capsule_Bucharest_redesigned_1.stl"),       mm,  G4ThreeVector( 0*cm, 0*cm, 0*cm), false);
